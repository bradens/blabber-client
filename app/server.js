...
import { LOBBY_ROOM_KEY, BLABBER_ADDRESS, SOCKET_NEW_MSG } from './constants';
...
export default class Server {
  ...
  static init(store) {
    ...
    if (localStorage.getItem('username'))
      connectObj['username'] = localStorage.getItem('username')
    ...
    lobbyChannel.onClose(e => console.log("lobbyChannelnel closed", e))
